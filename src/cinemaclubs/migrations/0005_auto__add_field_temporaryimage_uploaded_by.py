...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TemporaryImage.uploaded_by'
        db.add_column('cinemaclubs_temporaryimage', 'uploaded_by', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TemporaryImage.uploaded_by'
        db.delete_column('cinemaclubs_temporaryimage', 'uploaded_by_id')
