...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CinemaClub.url'
        db.alter_column('cinemaclubs_cinemaclub', 'url', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'CinemaClub.url'
        raise RuntimeError("Cannot reverse this migration. 'CinemaClub.url' and its values cannot be restored.")
