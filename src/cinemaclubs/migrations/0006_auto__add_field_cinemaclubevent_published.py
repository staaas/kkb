...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CinemaClubEvent.published'
        db.add_column('cinemaclubs_cinemaclubevent', 'published', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CinemaClubEvent.published'
        db.delete_column('cinemaclubs_cinemaclubevent', 'published')
