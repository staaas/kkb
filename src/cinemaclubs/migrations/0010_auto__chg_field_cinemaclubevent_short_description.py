...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'CinemaClubEvent', fields ['name']
        db.create_index('cinemaclubs_cinemaclubevent', ['name'])

    def backwards(self, orm):
        
        # Removing index on 'CinemaClubEvent', fields ['name']
        db.delete_index('cinemaclubs_cinemaclubevent', ['name'])
    ...
    models = {
        ...
        'cinemaclubs.cinemaclubevent': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '150', 'db_index': 'True'}),
            ...
            'short_description': ('cinemaclubs.fields.CharFieldWithTextarea', [], {'default': "''", 'max_length': '500', 'db_column': "'short_desciption'"}),
