...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'SocialPoster', fields ['event', 'service']
        db.delete_unique('cinemaclubs_socialposter', ['event_id', 'service'])

        # Deleting model 'SocialPoster'
        db.delete_table('cinemaclubs_socialposter')
    ...
    models = {
        ...
        'cinemaclubs.socialposter': {
            'Meta': {'unique_together': "(('event', 'service'),)", 'object_name': 'SocialPoster'},
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cinemaclubs.CinemaClubEvent']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'service': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
